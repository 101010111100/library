...
class Image_GD extends Image {
	...
	public static function check()
	{
		...
		{
			throw new \Phalcon\Exception('GD is either not installed or not enabled, check your configuration');
		}
		...
		{
			throw new \Phalcon\Exception(strtr('Image_GD requires GD version :required or greater, you have :version',
	...
	public function __construct($file)
	{
		...
		{
			throw new \Phalcon\Exception(strtr('Installed GD does not support :type images',
	...
	protected function _do_rotate($degrees)
	{
		...
		{
			throw new \Phalcon\Exception(strtr('This method requires :function, which is only available in the bundled version of GD',
