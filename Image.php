...
abstract class Image {
	...
	public function __construct($file)
	{
		...
		{
			throw new \Phalcon\Exception(strtr('Not an image or invalid image: :file',
				array(':file' => $file)));
		}
	...
	public function save($file = NULL, $quality = 100)
	{
		...
		if (is_file($file))
		{
			if ( ! is_writable($file))
			{
				throw new \Phalcon\Exception(strtr('File must be writable: :file',
					array(':file' => $file)));
			}
		}
		else
		{
			...
			{
				throw new \Phalcon\Exception(strtr('Directory must be writable: :directory',
